...
/**
 * @Author zbossz
 * @Date 2022年05月29日15时47分
 **/
public interface ViewSchoolListByTypeOp {
    public static void ViewSchoolListByNormalReapt(String type,int choice) {
        ...
        searchDialogForAdmin.searchTextArea.setText(type);
